...
.Example clauses in license for use of aeronautical meteorological data:
----
AERONAUTICAL METEOROLOGY DATA LICENSE
  ...
  This aeronautical meteorological data is provided under the following terms:
    ...
    This meteorological information is made available exclusively for the purposes of safety of international air navigation.

    RESTRICTIONS

    International Air Navigation Use Only: This data shall not be used for non-aviation purposes.

    No Redistribution: Redistribution of this data is prohibited unless specifically authorized.
...
> [!TODO] 
> Should the "No Redistribution" clause be included?
> How to improve the formatting?
...
----
origin/a/wis2/{centre-id}/data/core/weather/aviation/metar
----
